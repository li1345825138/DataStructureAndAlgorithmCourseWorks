package Autocomplete;// Accepts filename (String) and k (int) as command-line arguments; provides a GUI for the user
        ...
        public AutocompletePanel(String filename) {
            ...
            try {
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    if (tab == -1) {
                        System.err.println("No tab character in line " + (i + 1) + " of " +
                                filename);
                        System.exit(1);
                    }
